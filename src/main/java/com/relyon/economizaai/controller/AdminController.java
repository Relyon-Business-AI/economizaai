...
import com.relyon.economizaai.dto.response.GreyMerchantResponse;
import com.relyon.economizaai.dto.response.LlmReportResponse;
import com.relyon.economizaai.dto.response.MissingBrandProductResponse;
import com.relyon.economizaai.dto.response.ProductDeletionResponse;
import com.relyon.economizaai.dto.response.OrphanedObservationsResponse;
import com.relyon.economizaai.dto.response.ProductMergeResultResponse;
import com.relyon.economizaai.dto.response.PurgeObservationsResponse;
...
import com.relyon.economizaai.service.notifications.RelevanceReportService;
import com.relyon.economizaai.service.admin.AdminOverviewService;
...
public class AdminController {
    ...
    @Value("${economizaai.admin.dev-cleanup-enabled:false}")
    private boolean devCleanupEnabled;

    // Dev-only guard for QA/e2e test-data seeding (off on prod).
    @Value("${economizaai.admin.dev-seed-enabled:false}")
     ...
     * Disabled unless {@code economizaai.admin.dev-cleanup-enabled=true} — on prod these are
     ...
     * when given. Disabled unless {@code economizaai.admin.dev-seed-enabled=true}.
     */
